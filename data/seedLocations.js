...
function seedLocations(db) {
  ...
  const locations = [
    ...
    // NOTE: collapsed_bridge has boss_clue(0.10) & hidden(0.05) but seedEvents has no matching events — falls through to generic handler
    ...
    ['underground_city', '地下都市',
      ...
      '{"min_level":3}',
      '["desperate_refugee","tunnel_beast"]',
      /* event_pool: 未来内容, 待设计 */ '[]',
      3, 3, 0.95,
    ...
    ['sky_castle', '天空城堡',
      ...
      '{"min_level":8}',
      '["mirror_doppelganger","fallen_angel_remnant"]',
      /* event_pool: 未来内容, 待设计 */ '[]',
      8, 6, 1.10,
    ...
    ['creature_forest', '生物森林',
      ...
      '{"min_level":10}',
      '["worldline_paradox","mutated_myth_beast"]',
      /* event_pool: 未来内容, 待设计 */ '[]',
      10, 7, 1.15,
    ...
    ['abyss_rift', '深渊裂隙',
      ...
      '{"min_level":15}',
      '["story_plague_bearer","abyss_corrupted_sponsor","forgotten_character"]',
      /* event_pool: 未来内容, 待设计 */ '[]',
      15, 9, 1.25,
      '{"story":0.15,"side_story":0.08,"battle":0.22,"elite_battle":0.08,"boss_clue":0.04,"opportunity":0.08,"resource":0.12,"hidden":0.10,"nothing":0.13}'],
  ];
