...
function seedMainChapters(db) {
  ...
  const chapters = [
    ...
    ['main_ch02_meeting_protagonist', '主角与旗帜',
      ...
      'ch2_08_stage_final',
      '{"required_previous_chapter":"main_ch01_paid_service","required_resources":{"storyFragments":10,"scenarioProof":1},"required_level":2,"required_flags":["first_scenario_cleared"]}',
      '{"storyFragments":10,"scenarioProof":1}',
    ...
    ['main_ch03_constellation_sponsor', '星座的注视',
      ...
      'ch3_08_stage_final',
      '{"required_previous_chapter":"main_ch02_meeting_protagonist","required_resources":{"storyFragments":25,"scenarioProof":2,"constellationFavor":1},"required_level":4,"required_flags":["ch2_settled_flags"]}',
      '{"storyFragments":25,"scenarioProof":2,"constellationFavor":1}',
    ...
    ['main_ch04_throne_war', '王座战争',
      ...
      'ch4_08_volume1_end',
      '{"required_previous_chapter":"main_ch03_constellation_sponsor","required_resources":{"storyFragments":40,"scenarioProof":3,"constellationFavor":2,"kingToken":1},"required_level":6}',
      '{"storyFragments":40,"scenarioProof":3,"constellationFavor":2,"kingToken":1}',
