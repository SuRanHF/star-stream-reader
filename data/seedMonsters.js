...
function seedMonsters(db) {
  ...
  const monsters = [
    ...
    ['underground_overseer', '地下监工', '由原庇护所管理者黑化成的独裁者。他曾被选为最值得信赖的人——正是这份信任让他拥有了绝对的权力。他坐在一张由配给表格堆叠成的"王座"上，嘴角带着饥饿的微笑。', 25, 900, 85, 55, 42,
      '["配给令","告密者网络","饥饿暴政"]',
      '{"exp":400,"coins":350}',
      '[{"item_key":"crystallized_scenario","rate":0.80},{"item_key":"abyss_silk","rate":0.30},{"item_key":"star_fragment","rate":0.20}]',
      '["underground_city"]', 1],
    ['castle_grand_duke', '古堡大公', '王座战争遗留的失败者。几百年前他输掉了王座——但他拒绝接受这个结局。他用镜子复制了无数个自己的投影，在古堡的每一面镜子里继续进行着永远不会结束的王者仪式。', 28, 1050, 95, 62, 48,
      '["血统压制","贵族决斗邀请","镜中军团"]',
      '{"exp":500,"coins":450}',
      '[{"item_key":"star_fragment","rate":0.50},{"item_key":"sponsor_blessing_dust","rate":0.60},{"item_key":"dream_shard","rate":0.25}]',
      '["sky_castle"]', 1],
    ['rift_warden', '裂隙看守者', '由无数被遗忘的故事碎片拼接而成的人形。每一块碎片都是一段没人记得的剧情——一个被放弃的角色、一个被删改的结局、一个被读者跳过的章节。它守护着深渊中最古老的秘密：故事的死亡不是终结，而是被遗忘。', 30, 1200, 108, 70, 52,
      '["故事重编","遗忘洪流","结局否定"]',
      '{"exp":650,"coins":600}',
      '[{"item_key":"dream_shard","rate":0.50},{"item_key":"star_fragment","rate":0.40},{"item_key":"abyss_silk","rate":0.50}]',
      '["abyss_rift"]', 1],
  ];
